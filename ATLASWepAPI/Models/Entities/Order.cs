...
public partial class Order
{
    ...
    public virtual OrderReferenceNumber? OrderReferenceNumber { get; set; }

    public virtual ICollection<OrderSku> OrderSkus { get; set; } = new List<OrderSku>();

    public virtual ICollection<PaymongoPaymentIntent> PaymongoPaymentIntents { get; set; } = new List<PaymongoPaymentIntent>();

    public virtual ICollection<PaynamicsPaymentIntent> PaynamicsPaymentIntents { get; set; } = new List<PaynamicsPaymentIntent>();
